...
const ClassType = () => {
  return (
    ...
    //    <div className="classingtext">
    //     <div className="classing">
    //       <img src ="./yoga3D.png" alt ="" className='yoga_ex'/>
    //     </div>
    ...
    <div className="imagesclass">
      <div className="imageclass">
        <img src="./class-yoga22.jpg" alt="Image 1" width= '350px' height='350px' />
        <h3>Yoga</h3>
        <p>Acquire High Level Of Mobility And Movement</p>
      </div>
      <div className="imageclass">
        <img src="./class-yoga14.jpg" alt="Image 2" width= '300px' height='300px' />
        <h3>Meditation</h3>
        <p>Melt Stress , Achieve Peace</p>
      </div>
      <div className="imageclass">
        <img src="./class-yoga23.jpg" alt="Image 3" width= '300px' height='300px' />
        <h3>Fusion</h3>
